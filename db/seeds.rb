...
# recipe = Recipe.create(name: "whiskey oj", alcoholic: "yes", ingredients: ["whiskey", "orange juice"], measurements: ["fsd3242", "sadfas23"], instructions: "asfakljdfklasjdfkjaksdfjajsfja;kfj;jksjlkfjdsfa;lksdjflkajsdflkjasdlkfjaslkd245q3453434fjlaksjdflkasjkljafajksdhf;ajfdkjaskdfj;lakjsdf;jsadkfjslkjfd;lkj")
# recipe = Recipe.create(name: "long island", alcoholic: "yes", ingredients: ["watermelon absolut", "lemon juice"], measurements: ["fs234234d", "sdfa2342df"], instructions: "asfakljdfklasjdfkjaksdfjajsfja;kfj;jksjlkfjdsfa;lksdjflkajsdflkjasdlkfjaslkreq3h4434u8qpo8o8uypdfjlaksjdflkasjkljafajksdhf;ajfdkjaskdfj;lakjsdf;jsadkfjslkjfd;lkj")
# recipe = Recipe.create(name: "old fashioned", alcoholic: "yes", ingredients: ["irish whiskey", "orange bitters", "lemon juice"], measurements: ["asdfacs", "geweerg", "adhflkuwh8"], instructions: "asfakljdfklasjdfkjaksdfjajsfja;kfj;jksjlkfjdsfa;lksdjflkajsdflkjasdlkfjaslkreq3h4434asdfjasdkfjaju8qpo8o8uypdfjlaksjdflkasjkljafajksdhf;ajfdkjaskdfj;lakjsdf;jsadkfjslkjfd;lkj")
